import { BehaviorOnMxFailure, ReputationEntityType, SendingStatus, SuppressionListReason } from "@aws-sdk/client-sesv2/dist-types/models/enums";
import { type BulkEmailContent, type Destination, type EmailContent, type EmailTemplateContent, type EventDestinationDefinition, type ListManagementOptions, BulkEmailEntry, BulkEmailEntryResult, MessageTag, Tag, Topic, TopicPreference } from "@aws-sdk/client-sesv2/dist-types/models/models_0";
/**
